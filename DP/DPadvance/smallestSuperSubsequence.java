...
Sample Output 2 :
9 */
public class smallestSuperSubsequence {
...
public static void main(String[] args) {
    ...
    String str1 = "ab";
    String str2 = "ac";
    System.out.println("Shortest super sequence length: " + smallestSuperSequence(str1, str2)); // Output: 3
    
    String str3 = "pqqrpt";
    String str4 = "qerepct";
    System.out.println("Shortest super sequence length: " + smallestSuperSequence(str3, str4)); // Output: 9
}
}
